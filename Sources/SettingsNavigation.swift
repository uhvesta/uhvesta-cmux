...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.app, "diff-viewer-branch-base", String(localized: "settings.app.diffViewerBranchBaseRef", defaultValue: "Default Branch Diff Base"), "diff branch base ref origin main master upstream review comparison"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "app.diffViewerBranchBaseRef": settingID(for: .app, idSuffix: "diff-viewer-branch-base"),
