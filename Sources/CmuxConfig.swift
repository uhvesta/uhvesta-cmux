...
struct CmuxSurfaceTabBarButton: Codable, Sendable, Hashable, Identifiable {
    ...
    static let newReviewTab = actionReference(CmuxSurfaceTabBarBuiltInAction.newReviewTab.configID)
...
struct CmuxResolvedConfigAction: Identifiable, Sendable, Hashable {
    ...
    static func builtIn(_ builtIn: CmuxSurfaceTabBarBuiltInAction) -> CmuxResolvedConfigAction {
        ...
        case .newReviewTab:
            title = String(localized: "command.newReviewTab.title", defaultValue: "New Review Tab")
            keywords = ["new", "review", "diff", "changes", "git"]
        case .splitRight:
