...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .app, id: "diff-viewer-branch-base", title: String(localized: "settings.app.diffViewerBranchBaseRef", defaultValue: "Default Branch Diff Base"), paths: ["app.diffViewerBranchBaseRef"], synonyms: "diff branch base ref origin main master upstream review comparison"),
